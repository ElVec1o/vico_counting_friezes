...
What is not machine-checked is stated as such. Theorem~\ref{thm:farey} rests on Theorem~B
of \cite{KSSZ}, which is cited and not reproved: the quotient by $SL_2(\Z)$ and the
surjectivity of the correspondence are not formalized here, and the results of
Section~\ref{sec:farey} are statements about the explicit construction rather than a proof
of that classification. The external inputs of Shiu and of Linnik are
