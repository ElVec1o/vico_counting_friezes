...
Karpenkov, Short, van Son and Zabolotskii classify these friezes by the minimal clockwise
paths of a Farey graph. Their classification is counted here: the number of minimal closed
...
\section{Counting the paths of Theorem B of \cite{KSSZ}}\label{sec:farey}

Karpenkov, Short, van Son and Zabolotskii classify the objects counted here. For positive
integers $N,K,R$ with $N=KR$, their Theorem~B puts the minimal clockwise paths of length
...
common divisor, and Theorem~B of \cite{KSSZ} identifies the class with divisor $K$ with the
path classes in $\mathcal F_{N/K}$; the count therefore depends only on $R=N/K$. Möbius
...
bijection at each $M$ separately.
